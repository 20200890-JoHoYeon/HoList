<div id="main_side_nav_area">
    ...
    <div id="front" class="clickmenu">
        ...
        <a class="l_menu_a" onclick="fnCheckMenu('front_popup')">레이어팝업</a>
        <a class="l_menu_a" onclick="fnCheckMenu('front_comment')">덧글달기</a>
        <a class="l_menu_a" onclick="fnCheckMenu('front_popupInput')">팝업입력</a>
    </div>

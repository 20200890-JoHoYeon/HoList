...
<body>
            ...
            <div id="main_con_area_notis">
                <div class="main_con_area_noti star_con_area">
                    ...
                    <div class="message_noti">
						<input class="multiply_input multiply_input_long" type="number" value="" id="one_value">
                        <button class="star_btn" onclick="FnOneMultiply('n_Multi')">출력</button>
                    </div><br><br>
                    ...
                    <div class="message_noti">
                        ...
                        <button class="star_btn" onclick="FnMultiply('nm_Multi')">출력</button>
                    </div><br><br>
					<h2 class="message_noti">2단 ~ 9단 출력 (ex: -> 2 x 2 = 4 ··· 9 x 9 = 81)</h2><br>
                    <div class="message_noti">
                        <button class="star_btn star_btn_long" onclick="FnMultiply('two_nine')">2단 ··· 9단 출력</button>
                    </div><br><br>
					<h2 class="message_noti">10단 ~ 19단 출력 (ex: -> 10 x 2 = 20 ··· 19 x 19 = 81)</h2><br>
                    <div class="message_noti">
                        <button class="star_btn star_btn_long" onclick="FnMultiply('ten_nineteen')">10단 ··· 19단 출력</button>
                    </div><br><br>
                </div>
            </div>
        </div>
    ...
    <script>
		function FnOneMultiply(shapeId) {
			let oneValue = document.getElementById('one_value').value;
			if(oneValue == "" || oneValue <= 0) {
				alert("잘못된 값을 입력하셨습니다. 다시 입력해주세요");
				oneValue = document.getElementById('one_value').value = "";
				document.getElementById('one_value').focus();
			}
			console.log(oneValue);
		}
        function FnMultiply(shapeId) {
			
			let startValue = document.getElementById('first_n_value').value;
			let lastValue =  document.getElementById('last_m_value').value;

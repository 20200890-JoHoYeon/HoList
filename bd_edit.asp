	...
	<body>
		...
		<div id="main">
			<div id="main_nav_area">
				...
				<span><h2 class="message">게시글 수정하기</h2></span>
				<form action="bd_list.asp" method="post">
					<table> 	
						<tr><td class="header">제목</td></tr>
						<tr><td><input type="text" placeholder="제목을 입력하세요" name="title" value="사전에 등록한 데이터 입니다."></td></tr>
						<tr><td class="header">작성자</td></tr>
						<tr><td><input type="text" placeholder="제목을 입력하세요" name="title" value="사전에 등록한 데이터 입니다."></td></tr>
						<tr><td class="header">내용</td></tr>
						<tr><td><textarea placeholder="내용을 입력하세요" name="detail">사전에 등록한 데이터 입니다.</textarea></td></tr>
						<tr><td><input type="submit" value="수정 완료" onclick="alert('수정 완료!')"></td></tr>
					</table>
				</form>
			</div>
		</div>
